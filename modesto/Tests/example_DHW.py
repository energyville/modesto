...
def construct_model():
    ...
    dhw_design = {'delta_T': 20,
                  'heat_profile': qDHW,
                  'mult': 1}

    optmodel.change_params(dict=dhw_design, node='zwartbergNE',
                           comp='DHW')
...
if __name__ == '__main__':
    ...
    # soc_DHW = optmodel.get_result('soc', node='zwartbergNE', comp='DHW')
    Q_DHW = optmodel.get_result('heat_flow', node='zwartbergNE', comp='DHW')
    ...
    # ax7.plot(soc_DHW, label='SOC')
    # ax7.set_title('DHW tank')
    # ax7.legend()

    ax8 = fig6.add_subplot(212)
    ax8.plot(Q_DHW, label='Heat flow')
    ax8.set_title('DHW tank')
    ax8.legend()
