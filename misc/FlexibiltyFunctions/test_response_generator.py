...
test = ResponseFunctionGenerator('sensitivity_network_size_genk', horizon=7*24*3600, start_time=pd.Timestamp('20140101'), time_step=900)
...
test.create_sens_cases(['Pipe length'])  # , 'Pipe length', 'Pipe diameter', 'Heat demand', 'Supply temperature level',
